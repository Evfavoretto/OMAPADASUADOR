...
<head>
  ...
  <style>
    :root{
      ...
      /* altura da barra fixa (pra compensar no layout) */
      --topbar-h: 92px;
    }
    ...
    *{box-sizing:border-box}
    ...
    /* ==========================================================
       1) FORÇAR SUMIR COM "TÍTULO AZUL" / HEADER DO TEMA GITHUB
       (Cayman, Minima, Slate, etc.) — vários seletores comuns
       ========================================================== */
    body > header,
    header.page-header,
    header.site-header,
    ...
    /* Alguns temas colocam o conteúdo dentro de .main-content/.container */
    ...
    /* ==========================================================
       2) BARRA LILÁS FIXA (COBRE QUALQUER RESTO QUE O TEMA JOGAR)
       ========================================================== */
    .topbar{
      position:fixed;
    ...
    /* espaço para não ficar escondido atrás da barra fixa */
    .page{
...
<body>
  <!-- BARRA FIXA (COBRE O QUE O GITHUB TENTAR MOSTRAR) -->
  <div class="topbar">
  ...
  <script>
    // Número: 49 99811-0445 (BR) => 55 + 49 + 998110445
